    ...
    public class PizzaAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>()//table
                ...
                .HasForeignKey(x => x.OrderId); //FK - foreign key
            ...
            modelBuilder.Entity<Feedback>()
                .HasData(new Feedback
                {
                    Id = 1,
                    Name = "PizzaQuality",
                    Email = "stefantrajkov@hotmail.com",
                    Message = "The pizza was very tasty."
                },
                new Feedback
                {
                    Id = 2,
                    Name = "ServiceQuality",
                    Email = "bojandamchevski@hotmail.com",
                    Message = "The service was great."
                });
        }
    }
}
