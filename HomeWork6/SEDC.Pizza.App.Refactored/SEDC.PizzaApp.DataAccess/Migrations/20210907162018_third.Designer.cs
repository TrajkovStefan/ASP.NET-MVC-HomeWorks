...
namespace SEDC.PizzaApp.DataAccess.Migrations
{
    ...
    [Migration("20210907162018_third")]
    partial class third
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Feedback", b =>
                {
                    ...
                    b.Property<int?>("NewFeedbackId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("NewFeedbackId");
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Feedback", b =>
                {
                    b.HasOne("SEDC.PizzaApp.Domain.Models.Feedback", "NewFeedback")
                        .WithMany()
                        .HasForeignKey("NewFeedbackId");
                });
